...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `b53e061` (rama del plan `docs/feat-009-beta7-plan`, sobre `main` `73c7146`). Entrega y PR: ver la fila de cierre al final de esta tabla una vez commiteado |
