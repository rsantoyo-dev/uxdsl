...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `159c357` (2026-09-22, el merge de PR #3 a `main`, HEAD de la rama al iniciar). Entrega: `9218691` en `feat/feat-008-beta6-plan`; PR pendiente de abrir |
