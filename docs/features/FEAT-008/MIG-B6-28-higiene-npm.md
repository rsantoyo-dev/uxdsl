...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `fbe097c` (2026-09-21). Entrega: `a103344` en `feat/feat-008-beta6-plan`; corrección de revisión (bug del hash en `release.js`, ver Límites (8)): commit siguiente; PR pendiente de abrir |
