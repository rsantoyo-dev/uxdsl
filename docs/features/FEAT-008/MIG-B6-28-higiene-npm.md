...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `fbe097c` (2026-09-21). Entrega: commit siguiente en `feat/feat-008-beta6-plan`; PR pendiente de abrir |
