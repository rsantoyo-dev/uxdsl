...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `f742378`; primera entrega en `097ee88`; correcciones de revisión de código en `fd1f432`, ambos en `feat/feat-008-beta6-plan`; sin PR abierto todavía |
