...
| MIG-B6-30 | [applyTheme(json): un modelo de tema en build y runtime](MIG-B6-30-apply-theme-runtime.md) | B — Tema base y salida correcta | P1 · L | 29, 17, 27 | Implementada/verificada en `feat/feat-008-beta6-plan` en 4 fases (`13ff49f`, `ed529d7`, `f7824ef`, ver ficha) — API síncrona por documento, puerta estructural derivada de los propios emisores del compilador, migración de las cuatro claves antiguas que nunca deja al usuario sin ninguna copia, y el playground aplicando su tema por el runtime en vez de por su propia copia. 20 comprobaciones en Chrome sobre el runtime **empaquetado**. Ningún setter antiguo eliminado; las tres capacidades sin equivalente están documentadas. Ver "Límites y seguimiento"; integración a `main` pendiente |
