...
| MIG-B6-23 | [Watch robusto](MIG-B6-23-watch-robusto.md) | D — CLI | P1 · M | 18, 24 | Implementada/verificada en `feat/feat-008-beta6-plan` (commit siguiente) sin esperar 24 — ver "Límites y seguimiento" de la ficha; integración a `main` pendiente |
