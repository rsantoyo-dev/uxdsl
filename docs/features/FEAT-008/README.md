...
| MIG-B6-29 | [El JSON base es la única fuente de defaults](MIG-B6-29-json-base-unica-fuente.md) | B — Tema base y salida correcta | P0 · L | 15 | Fase 1/4 implementada/verificada en `feat/feat-008-beta6-plan` (`a078c51`, corrección de revisión en `fe23608`) — mover JSON + extraer 7 familias + migrar playground, sin gate de contraste ni corrección de color (repartida en fases por pedido del dueño dado el tamaño/impacto excepcionales) — ver "Límites y seguimiento" de la ficha; integración a `main` pendiente |
