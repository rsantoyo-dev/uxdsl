...
| MIG-B6-18 | [`compile()` compartido en `uxdsl-core`](MIG-B6-18-compile-compartido.md) | C — Un solo pipeline (**camino crítico**) | P0 · L | 22 | Implementada/verificada en `feat/feat-008-beta6-plan` (commit siguiente); integración a `main` pendiente |
