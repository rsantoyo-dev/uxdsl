...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `1eb9346` (2026-09-22, HEAD de la rama al iniciar). Entrega: `02f4c7e` en `feat/feat-008-beta6-plan`; PR pendiente de abrir. Los paquetes siguen en `0.5.0-beta.5`: el bump pertenece a la publicación, fuera de alcance |
