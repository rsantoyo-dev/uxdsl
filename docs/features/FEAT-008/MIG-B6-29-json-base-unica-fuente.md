...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `7d4d70d` (2026-09-21). Entrega: `a078c51` en `feat/feat-008-beta6-plan`. Corrección de revisión (bug real reportado por el dueño en vivo, ver Límites (9)): commit siguiente. PR pendiente de abrir |
