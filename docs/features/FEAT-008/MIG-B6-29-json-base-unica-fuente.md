...
| Campo | Evidencia |
| --- | --- |
| SHA base / entrega / PR | Base `7b467d2` (2026-09-22, HEAD de `feat/feat-008-beta6-plan` al iniciar esta fase). Entrega: commit siguiente en `feat/feat-008-beta6-plan`; PR pendiente de abrir |
