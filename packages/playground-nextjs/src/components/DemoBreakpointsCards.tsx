...
export default function DemoBreakpointsCards() {
  return (
    <div className="demo-breakpoints-cards">
      <div className="demo-breakpoints-card-item">
        <div style={{ color: 'var(--uxdsl-color-primary-main)' }}>
      ...
      <div className="demo-breakpoints-card-item">
        <div style={{ color: 'var(--uxdsl-color-secondary-main)' }}>
      ...
      <div className="demo-breakpoints-card-item">
        <div style={{ color: 'var(--uxdsl-color-info-main)' }}>
