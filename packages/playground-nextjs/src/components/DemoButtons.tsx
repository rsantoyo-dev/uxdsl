...
export default function DemoButtons() {
  ...
  const css = useMemo(() => [generateDensityCss(getDensityTokens(theme), { ...DEFAULT_BREAKPOINTS, ...theme.breakpoints }, '#DemoButtons'), generateEdgeCss(theme, undefined, '#DemoButtons'), generateShadowCss(theme, undefined, '#DemoButtons'), generateSurfaceCss(theme, undefined, '#DemoButtons'), generateButtonCss(theme, undefined, '#DemoButtons'), ...Object.keys(tokens).map(role => buttonComponentCss(theme, `#DemoButtons [data-button-role="${role}"]`, role, tone, size))].join('\n'), [theme, tokens, tone, size])
